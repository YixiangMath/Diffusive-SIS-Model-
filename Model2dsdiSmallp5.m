...
saveas(h, '/Users/ywu/Library/Mobile Documents/com~apple~CloudDocs/My Papers/2023-2-SI with nonlinear incidence-PengRui-Salako/model2dsdiSp5', 'epsc');


h=figure
%pdeplot(model,"XYData",sol.NodalSolution(:,2,T),"ZData",sol.NodalSolution(:,2,T))
pdeplot(model,"XYData",sol.NodalSolution(:,2,T))
saveas(h, '/Users/ywu/Library/Mobile Documents/com~apple~CloudDocs/My Papers/2023-2-SI with nonlinear incidence-PengRui-Salako/model2dsdiIp5', 'epsc');
